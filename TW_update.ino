...
/*void T_Parking()
{
    ...
    for(int count=0; count<2; )
    {
      ...
      { 
        ...
        while(1)
        {
         ...
         SetSpeed(-0.5);
         delay(15);
         if((abs(GetDistance(L_TRIG, L_ECHO)-GetDistance(R_TRIG, R_ECHO))<50 &&abs(GetDistance(L_TRIG, L_ECHO)-GetDistance(R_TRIG, R_ECHO))>0)|| GetDistance(L_TRIG, L_ECHO)<80 ) 
         {
          SetSteering(0);
          SetSpeed(0);
          delay(50);
          if(GetDistance(L_TRIG, L_ECHO)<50)
          {
            SetSteering(1);
            SetSpeed(0.5);
            delay(100);
  ...
  /*      if(GetDistance(L_TRIG, L_ECHO)<100)
        {     
          while(1)
          { 
           SetSpeed(-0.25);
           SetSteering(0.25);
           delay(300);
           if(GetDistance(L_TRIG, L_ECHO)>300)
           {
            while(1)
            {
            ...
            if(GetDistance(L_TRIG, L_ECHO)<250)
            {
              SetSteering(-0.4);
              SetSpeed(-0.1);
              delay(100);
